...
# 4. Install Python and Tkinter for the virtual environment
RUN apt-get update && \
...
# 6. Copy the rest of your game files into the container
COPY . .

# 7. Tell the container to launch your game automatically when the virtual desktop starts
